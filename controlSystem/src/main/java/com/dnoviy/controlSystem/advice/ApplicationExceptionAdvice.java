...
//    // 404
    ...
    public ErrorMessage errorNoElement(Exception ex, WebRequest request) {
        return standardErrorMessage(HttpStatus.BAD_GATEWAY, Arrays.asList(ex.getMessage()), request);
    }
